...
The two function describe above are used in the distPoint2Lines function that computes the shortest distance between a set of points and a set of spherical polylines (or polygons).
